...
%\paragraph \indent
%Knowing all upcoming tiles, and by being able to determine the location they will be placed means that our 
%Large input data sets remove the ability to search all possible combinations of moves.
