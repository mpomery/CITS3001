...
You are only able to merge a one tile with a two tile, whereas with any other tile you can merge it with one of the same value.
...
Multiple iterations of A* algorithms were implimented, giving us a 
